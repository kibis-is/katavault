...
slug: /core/accounts/use-set-account-name-by-key
---
...
`(error: BaseError, params: SetAccountNameByKeyParameters) => void | Promimse<void>`

This will be invoked if there was an error.

#### onSuccess

`(result: Account, params: SetAccountNameByKeyParameters) => void | Promimse<void>`
