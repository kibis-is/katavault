...
As explained in the [core](02-core/03-api/02-getting-started.mdx#2-authentication) documentation, before the app is able to start using the provider, the user **MUST** authenticate.
