---
id: use-remove-listener
sidebar_label: useRemoveListener
slug: /react/utilities/use-remove-listener
title: useRemoveListener
---
...
A function that can be used to remove a listener by the supplied ID.

## See also

* [removeListener](02-core/03-api/06-utilities/05-remove-listener.mdx)
