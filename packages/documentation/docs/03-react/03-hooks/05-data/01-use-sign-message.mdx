...
Type: `(error: BaseError, params: SignMessageParameters) => void | Promise<void>`

This will be invoked if there was an error.

#### options.onSuccess

Type: `(result: string | Uint8Array, params: SignMessageParameters) => void | Promise<void>`
...
* [signMessage](02-core/03-api/05-data/01-sign-message.mdx)
